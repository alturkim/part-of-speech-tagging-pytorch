"""
Credit:
Original Author: Sagar Vinodababu
See:
https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Sequence-Labeling/blob/041f75a37497bd1b712a426b7d18631251ecd749/inference.py

Modified by: Mustafa Alturki, July 2020
...
class ViterbiDecoder():
    ...
    def decode(self, scores, lengths):
        ...
        scores_upto_t = torch.zeros(batch_size, self.tag_set_size)

        # Create a tensor to hold back-pointers
        # i.e., indices of the previous_tag that corresponds to maximum accumulated score at current tag
        # Let pads be the <end> tag index, since that was the last tag in the decoded sequence
        backpointers = torch.ones((batch_size, max(lengths), self.tag_set_size), dtype=torch.long) * self.end_tag
        ...
        for t in range(max(lengths)):
            ...
            if t == 0:
                ...
                backpointers[:batch_size_t, t, :] = torch.ones((batch_size_t, self.tag_set_size),
